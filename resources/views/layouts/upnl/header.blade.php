...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="/">
            <img alt="Logo" src="{{asset('')}}upnl/images/1.png" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand logo-brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="/" class="brand-logo">
                        <img alt="Logo" style="width:142px;" src="{{asset('')}}upnl/images/1.png"/>
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route('user.fund')}}" class="menu-link">
                                    <span class="svg-icon menu-icon sidemenu-icon">
...
{{-- 
                            ...
                            {{-- <li class="menu-item" aria-haspopup="true">
                                <a href="/rngapp/transfer-fund/RNG49911549" class="menu-link">
                                    <span class="svg-icon menu-icon sidemenu-icon">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="{{route('user.withdraw-request')}}" class="menu-link">
                                                <span class="menu-text">Request Withdrawal</span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <a href="{{route('user.roi-bonus')}}" class="menu-link">
                                                <span class="menu-text">Single Leg Income</span>
                                            </a>
                                        </li>
