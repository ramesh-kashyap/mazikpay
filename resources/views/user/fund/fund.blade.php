...
<div class="no-tp-gap content d-flex flex-column flex-column-fluid " id="kt_content">
    ...
    <div class="d-flex flex-column-fluid section-top-50">
        ...
        <div class="container-fluid">
            <!--begin::Dashboard-->
            <form class="form mt-0"  method="POST"
                    ...
                    <div class="col-xl-6 offset-xl-3">
                        ...
                        <div class="invest-main-wrap transaction-card-wrap">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        ...
                                        <input type="" name="amount" class="form-control"
                                            autocomplete="off" placeholder="Enter Amount"  value=""required
                                            value="">
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        <label for="investfromwallet">Select Payment Mode</label>
                                        <input type="text" name="paymentMode" class="form-control check_sponsor_exist"
                                            autocomplete="off" placeholder="paymentMode" data-response="sponsor_res"
                                            required value="">
