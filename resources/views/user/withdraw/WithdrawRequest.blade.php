    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Make Withdrawal <span
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        ...
                        <div class="invest-main-wrap transaction-card-wrap">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        ...
                                        size="32" value="{{currency()}} {{ number_format(Auth::user()->available_balance(), 2) }}"  disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        <label for="investfromwallet">Currency</label>
                                        <input type="text" name="paymentMode"  class="form-control"
                                        size="32" value="INR"  disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left" >
                                        ...
                                        <input type="textbox" name="amount"  placeholder="Enter Amount" required class="form-control"
                                            value="" >
                                    </div>
                                ...
                                <div class="col-lg-12" >
                                    <div class="form-group mt-2 mb-3 text-left">
                                        ...
                                        <input type="password" name="transaction_password"  class="form-control" autocomplete="off" placeholder="Transaction Password"  required value="">
                                    </div>
                                </div>
                            ...
                            <div class="al-center">
                                <button type="submit" class="btn btn-primary report-btn">Make Withdrawal <span
