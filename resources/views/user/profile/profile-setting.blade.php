                                            ...
                                            <div class="profile-bottom">
                                                <div class="profile-bottom__center">
                                                    <div class="profile-bottom__img">
                                                        <div>
                                                            <img src="{{ asset('') }}assets/guest-assets/images/<?php if(Auth::user()->active_status=="Active"){echo "icon-member-active";}else{echo "icon-member-pending";}?>.png"
                                                                alt="User" draggable="false">
                                                        </div>
                                                    </div>
                                                    <div class="profile-bottom__btm">
                                                        <h4>{{($profile_data)?$profile_data->name:''}} </h4>
                                                        <span style="color: #29c7e0">Member ID: <strong>{{($profile_data)?$profile_data->username:''}}</strong></span>
                                                        <span style="color: #29c7e0">Date of Joining: <strong><?php echo date("D, d M Y", strtotime(Auth::user()->jdate))?></strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="upc-content">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        <span>Position</span>
                                                        <p>{{($profile_data)?$profile_data->position:''}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <a class="nav-link" id="nominee-tab" data-toggle="tab" href="#nominee" role="tab" aria-controls="nominee" aria-selected="false">Nominee Details</a>
                                        ...
                                        <div class="tab-content mt-5" id="myTabContent">
                                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                                ...
                                                <form method="post" name="formmainprf" action="">
