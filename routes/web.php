...
Route::get('/investment', [App\Http\Controllers\FrontController::class, 'investment'])->name('investment');
...
Route::get('/fund', [App\Http\Controllers\UserPanel\AddFund::class, 'fund'])->name('user.fund');
